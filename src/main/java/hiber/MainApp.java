...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      Car car1 = new Car("BMW",230);
      Car car2 = new Car("Chevrellet",230);
      Car car3 = new Car("Audi",230);
      Car car4 = new Car("Mercedes",230);
      ...
      User user = userService.getUserByCarsModelAndSeries("BMW",230);
      System.out.println("From hql query" + user.getCar());
      context.close();
   }
}
